...
static inline _CompressionUnifiedErrorCode _z_stream_init(z_stream *compress_stream, GString *compressed,
...
static inline _CompressionUnifiedErrorCode _deflate_type_compression_method( GString *destination,
