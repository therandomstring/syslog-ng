...
Also, fuzzing need not be done as often as unit testing.\
  ...
  if(ADD_FUZZ_TEST_EXPERIMENTAL)
    ...
    set_target_properties(${ADD_FUZZ_TEST_TARGET} PROPERTIES COMPILE_FLAGS "-o1 -fsanitize=\"fuzzer,address,signed-integer-overflow,null,alignment\" -fno-omit-frame-pointer")
    set_target_properties(${ADD_FUZZ_TEST_TARGET} PROPERTIES LINK_FLAGS "-o1 -fsanitize=\"fuzzer,address,signed-integer-overflow,null,alignment\" -fno-omit-frame-pointer")
